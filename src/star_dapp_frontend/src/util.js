...
export const generate_star_dapp_key = async () => {
  ...
  return {
    ...
    ...{ publicStr: exportedAsBase64, privateStr: exported_privateAsBase64 },
  };
};

export const import_star_dapp_key = async (publicStr, privateStr) => {
  try {
